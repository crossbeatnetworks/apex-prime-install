...
The procedure is largely based on the tutorial provided by Kash Pool at https://apexkash.com/  
The server hardening portion is based on the tutorials at https://www.coincashew.com/  
